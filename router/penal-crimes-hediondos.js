...
async function scraping() {
    try {
        ...
        const [registro, criado] = await PenalCrimesHediondos.findOrCreate({
...
penalCrimesHediondos.get('/', async (req, res) => {
    try {
        ...
        const dados = await PenalCrimesHediondos.findOne({ where: { id: 1 } }); // Altere o critério conforme necessário
