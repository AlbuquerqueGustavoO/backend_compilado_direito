...
async function scraping() {
    try {
        ...
        const [registro, criado] = await PenalOrganizacaoCriminosa.findOrCreate({
...
penalOrganizacaoCriminosa.get('/', async (req, res) => {
    try {
        ...
        const dados = await PenalOrganizacaoCriminosa.findOne({ where: { id: 1 } }); // Altere o critério conforme necessário
